...
export const STATUS_LABELS: Record<string, string> = {
  ...
  'first_page_fetched': 'Primeira página da API obtida',
  'external_api_failed_using_cache': 'API externa falhou, usando cache',
  'external_api_error_using_cache': 'Erro na API externa, usando cache',
  'external_api_failed_trying_cache': 'API externa falhou, tentando cache',
  'using_cached_api_products': 'Usando produtos em cache',
